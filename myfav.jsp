...
ResultSet rs=st1.executeQuery("select * from "+rollno+" where itemid='"+id+"'");
if(rs.next()){c=1;}

if(id!=null && c==0){
PreparedStatement mystatement = con.prepareStatement("insert into "+rollno+" values(?)");
mystatement.setString(1, id);
int k=mystatement.executeUpdate();
}
ResultSet rs1=st1.executeQuery("select * from "+rollno);
